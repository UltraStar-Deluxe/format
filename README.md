...
We aim to reduce the use of proprietary and undefined headers that can be found in thousands of UltraStar songs and thus make the songs accessible to everyone in the karaoke community.
We hope that this can be a step to unite the various communities that currently each *do their own thing*.
...
- [x] Introduce a versioning strategy for the file format as well as processes for the standardization of new features. See [VERSIONING.md](https://github.com/Ultrastar-Deluxe/format/blob/main/VERSIONING.md)
...
If you want to contribute to this project, check out our [contribution guidelines](https://github.com/UltraStar-Deluxe/format/blob/main/.github/CONTRIBUTING.md).
